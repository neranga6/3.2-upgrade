			...
			<ul class="errors" role="alert">
	     	...
	     	<g:form id="createTemplateSelectionForm" action="create" >
				...
				<label for="newModelTemplate">
				 ...
				 <br />
				<g:select  id="newModelTemplate" class="model.id" from="${com.nationwide.edm.authoring.Model.list()}" optionKey="id" value="${model?.id}"
		          name="newModelTemplate" noSelection="['':'-select-']"/>
		        <g:select style='display:none;' id="modelExistingTemplate" class="letterTemplate.id" from="${com.nationwide.edm.authoring.LetterTemplate.list()}" optionKey="id" value="${letterTemplate?.id}"
